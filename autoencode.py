...
LOGDIR = r"C:\PycharmProjects\py3\tmp\mnist_tutorial"
...
### MNIST EMBEDDINGS ###
mnist = tf.contrib.learn.datasets.mnist.read_data_sets(train_dir=os.path.join(LOGDIR, 'data'), one_hot=True)
### Get a sprite and labels file for the embedding projector ###

urlretrieve(GIST_URL + 'labels_1024.tsv', os.path.join(LOGDIR, 'labels_1024.tsv'))
urlretrieve(GIST_URL + 'sprite_1024.png', os.path.join(LOGDIR, 'sprite_1024.png'))
